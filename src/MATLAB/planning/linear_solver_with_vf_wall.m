%% Title:    THA 4, Part C - Distance & Joint Limits Constraints with Virtual Wall
...
for z = 1:p_rows/4
    ...
    if (IsGood == true)
        ...
        while (error_w > eps_w && error_v > eps_v && abs(y_location) > 4 && IsGood == true)
            ...
            dt = [0 , 1 , 0];  % Define vector perpindicular to the plane (y-direction)
            A4 = [ -dt , 0 , 0 , 0];
            ...
            A = [LhsConst1;LhsConst2;LhsConst4];
            b = [RhsConst1;RhsConst2;RhsConst4];
