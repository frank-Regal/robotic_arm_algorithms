%% Title:    THA 4, Part A - Distance and Joint Limit Constraints
...
for z = 1:p_rows/4
    ...
    if(IsGood == true)
        ...
        while (error_w > eps_w && error_v > eps_v && IsGood == true)
            ...
            A = [LhsConst1;LhsConst2];
            b = [RhsConst1;RhsConst2];
        ...
        % /////////////////////////////////////////////////////////////
        % Check end distance
        end_dist = [end_dist; norm(p_goal - t(1:3))];
        disp("End Distance from goal: " + end_dist(z) + " mm");
