%% Title:    THA 2, PA Jacobian Transpose Test Script
...
fprintf("\n\n\n");
disp("////////////////////////////////////////////////////////////////");
disp("================= JAC TRANSPOSE TEST SCRIPT ====================");
...
% fig1 = figure();
% joint_angles = J_transpose_kinematics(Tsd,init_theta,fig1);
% title("Jacobian Transpose of Kuka (Part I): Reaching Singularity");
% hold off;
% 
% % Print Out
% fprintf("\n[Test 1] Jacobian Transpose Kinematics found the following Joint Angles will Reach Desired Configuration:\n\n")
...
% Run J Inverse Kinematics
fig2 = figure();
joint_angles = J_transpose_kinematics(Tsd,init_theta,fig2);
title("Jacobian Transpose of Kuka (Part I): Random Point");
hold off;

% Print Out
fprintf("\n[Test 2] Jacobian Transpose Kinematics found the following Joint Angles will Reach Desired Configuration:\n\n")
fprintf('\nResulting Joint Angles (1->6) [rad]:\n\n')
disp(joint_angles');
fprintf("\nDesired Configuration of End Effector:\n\n")
disp(Tsd);
